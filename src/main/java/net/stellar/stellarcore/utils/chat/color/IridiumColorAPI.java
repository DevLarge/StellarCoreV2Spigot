package net.stellar.stellarcore.utils.chat.color;

/*
The code in class IridiumColorAPI, is not to be used by anyone, without legitimate permission from https://github.com/DevLarge, Oscar#8373. 
...
import net.stellar.stellarcore.utils.chat.patterns.GradientPattern;
import net.stellar.stellarcore.utils.chat.patterns.Pattern;
import net.stellar.stellarcore.utils.chat.patterns.RainbowPattern;
import net.stellar.stellarcore.utils.chat.patterns.SolidPattern;
